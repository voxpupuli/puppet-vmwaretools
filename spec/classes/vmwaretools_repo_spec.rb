...
#    redhatish.each do |os|
#      describe "operatingsystem => #{os} and tools_version => 3.5u3" do
...
#      end
#
#      describe "operatingsystem => #{os} and tools_version => 4.0latest" do
...
#      end
#
#      describe "operatingsystem => #{os} and tools_version => 4.1latest" do
...
#      end
#
#      describe "operatingsystem => #{os} and tools_version => 5.0u1" do
...
#      end
#
#      describe "operatingsystem => #{os} and tools_version => 5.1" do
